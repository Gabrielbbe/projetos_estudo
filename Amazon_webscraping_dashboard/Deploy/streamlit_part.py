...
dados de hoje automaticamente você pode seguir as instruções da pagina do projeto no github: https://github.com/Gabrielbbe/projetos_estudo/tree/main/Amazon_webscraping_dashboard/Scripts \n  \
